...
const QMetaObject Clip::staticMetaObject = {
    { &ImageFilter::staticMetaObject, qt_meta_stringdata_Clip.data,
      qt_meta_data_Clip,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Clip::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Clip.stringdata0))
        return static_cast<void*>(const_cast< Clip*>(this));
