...
void HistoStretch::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        HistoStretch *_t = static_cast<HistoStretch *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject HistoStretch::staticMetaObject = {
    { &ImageFilter::staticMetaObject, qt_meta_stringdata_HistoStretch.data,
      qt_meta_data_HistoStretch,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *HistoStretch::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_HistoStretch.stringdata0))
        return static_cast<void*>(const_cast< HistoStretch*>(this));
